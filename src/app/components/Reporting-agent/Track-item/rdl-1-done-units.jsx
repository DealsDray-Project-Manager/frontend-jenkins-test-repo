            ...
            <ProductTable>
                <TableHead sx={{ position: 'sticky', top: 0, zIndex: 1 }}>
                    ...
                    <TableRow>
                        ...
                        <TableCell sx={{fontSize:'16px', fontWeight:'bold',  width:'180px'}}>RDL-1 Agent name</TableCell>
                        ...
                        <TableCell sx={{fontSize:'16px', fontWeight:'bold',  width:'250px'}}>Tray Closed By RDL-1 Date</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {displayText !== '' ? (
