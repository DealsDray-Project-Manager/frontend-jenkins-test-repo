            ...
            <Table sx={{ mb: 2 }}>
                <TableBody>
                    ...
                    <TableRow key={BqcSowftwareReport?.pq_batterybulging}>
                        <TableCell sx={{ pl: 2 }}>BQ Battery Bulging</TableCell>
                        <TableCell>
