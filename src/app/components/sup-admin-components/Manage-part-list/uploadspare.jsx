                ...
                >
                    ...
                    {item.length == 0 ? (
                        ...
                        <Button
                            ...
                            sx={{ mt: 3, mb: 1 }}
                            style={{ backgroundColor: '#206CE2' }}
                            onClick={() => navigate('/sup-admin/view-list/sparereporting1')}
                        >
                            Submit
                        </Button>
                    ) : (
...
<TableRow sx={{ }}>
          ...
          <TableBody>
            {products.map((phones, index) => (
              ...
              <TableCell align="center">{phones?.available_stock}</TableCell>        
              <TableCell align="center">{phones?.add_stock}</TableCell>        
              {/* <TableCell>
              <IconButton sx={{ml:9}}>
                              <Icon
